...
<h3>255 production-ready n8n workflows &mdash; sanitized, modernized, and organized</h3>
...
<p><em>AI agents, RAG chatbots, and document-extraction workflows for n8n.<br>Every workflow is stripped of credentials and secrets, modernized to current n8n nodes and AI models, and validated by CI.</em></p>
...
|---|:--:|---|
| 🤖 AI Agents & Chatbots &nbsp;·&nbsp; [`ai-agents-chatbots/`](workflows/ai-agents-chatbots/) | 169 | Autonomous agents and retrieval-augmented chatbots |
| 📄 Document & Data Extraction &nbsp;·&nbsp; [`document-data-extraction/`](workflows/document-data-extraction/) | 86 | PDF/OCR parsing, scraping, and structured extraction |
